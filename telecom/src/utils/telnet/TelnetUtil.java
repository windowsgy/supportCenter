...
public class TelnetUtil implements Callable<Object> {
    ...
    TelnetUtil(StruTelnetMap map) {
        ...
        gatMap.setStartDateTime(DateTimeUtils.getCurTime(DATE_FORMAT));
    }
    ...
    private boolean connectToServer() { //连接到服务器
        try {
            ...
            gatMap.setEndDateTime(DateTimeUtils.getCurTime(DATE_FORMAT));//设置结束时间
    ...
    private static boolean end(List<String> endList, String str) {
     ...
     * @return 每行指令
     */
    private static List<String> buildCmdList(String str) {
