...
public class Load {
    ...
    public static void  run(){
        ...
        Init.summaryJoinField = ListUtil.listArrField(Init.summaryListArr,0);

        LogInfo.info("加载明细文件关联字段");

        Init.detailJoinField = ListUtil.listArrField(Init.detailListArr,0);

        LogInfo.info("加载明细文件明细信息");

        Init.detailDetailField = ListUtil.listArrField(Init.detailListArr,2);

        LogInfo.info("加载明细文件日期信息");

        Init.detailDateField = ListUtil.listArrField(Init.detailListArr,1);
